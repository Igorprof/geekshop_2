...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        action_2_condition = Q(order__updated_at__lte = F('order__created_at') + action_2_time_delta,
        order__updated_at__gt = F('order__created_at') + action_1_time_delta)
        action_3_condition = Q(order__updated_at__gt = F('order__created_at') + action_2_time_delta)
